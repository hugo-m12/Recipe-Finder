...
function LoginView({ onLogin }) {
  ...
  return (
    ...
    <div className="flex flex-1 overflow-x-auto bg-white rounded-lg">
      <div className="font-[Poppins] container mx-auto flex flex-1 justify-center items-center bg-[url(/images/login_background.jpg)] bg-no-repeat bg-cover bg-center py-8">
